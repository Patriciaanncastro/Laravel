...
<head>
    ...
    <title>Keep for Future Records</title>
    <style>
        ...
        <table class="employee-table">
            ...
            <tbody id="employee-records">
                ...
                <tr>
                    ...
                    <td>{{$keep->Name}}</td>
                    <td>{{$keep->jobTitle}}</td>
                    <td>{{$keep->organization}}</td>
                    <td>{{$keep->updated_at}}</td>
                    <td class="actions">
                    <a href="{{route('profile.show', $keep->id)}}" class="view-btn">View</a>
                        <button class="edit-btn">Edit</button>
                        <form action="{{route('profile.destroy', $keep->id)}}" method="post">
                            @csrf
