...
<head>
    ...
    <title>Hired Employee Records</title>
    <style>
        ...
        <table class="employee-table">
            ...
            <tbody id="employee-records">
                ...
                <tr>
                    <td>{{$hired->id}}</td>
                    <td>{{$hired->Name}}</td>
                    <td>{{$hired->jobTitle}}</td>
                    <td>{{$hired->organization}}</td>
                    <td>{{$hired->updated_at}}</td>
                    <td class="actions">
                        <a href="{{route('profile.show', $hired->id)}}" class="view-btn">View</a>
                       
                        <form action="{{route('profile.destroy', $hired->id)}}" method="post">
                            @csrf
